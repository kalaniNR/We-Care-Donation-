<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="user_Sign_up.aspx.cs" Inherits="final_project.user_Sign_up" %>
            ...
            <div class="col-md-8 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="TextBox10">Account Status</label>
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col text-center">
                                <div class="form-group">
                                    <asp:Button CssClass="btn btn-primary" ID="Button1" runat="server" Text="Sign Up" OnClick="Button1_Click" />
                                </div>
